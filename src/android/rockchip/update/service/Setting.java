...
public class Setting extends Activity {
	...
	private CheckBox mCH_CheckFullUpgrade;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCH_CheckFullUpgrade =  (CheckBox)this.findViewById(R.id.swh_check_full_upgrade);
		if(!OTAConfig.hasCheckFullUpdate())
		{
			mCH_CheckFullUpgrade.setVisibility(View.GONE);
		}
	...
	public void checkUpdateByUser()
	{
		if(NetWork.checkNetworkConnect(mContext))
		{
			...
			serviceIntent.putExtra("check_full_upgrade", mCH_CheckFullUpgrade.isChecked());
