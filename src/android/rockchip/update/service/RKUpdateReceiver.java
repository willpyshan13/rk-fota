...
public class RKUpdateReceiver extends BroadcastReceiver
{
    ...
    private final static boolean isRemoteCheckAuto = true;//false仅手动查找网络升级.true为自动
 ...
 public static boolean isBootCompleted(){
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, "action = " + action+" ,isBootCompleted:"+isBootCompleted());
        ...
        }else if(isRemoteCheckAuto && action.equals(ConnectivityManager.CONNECTIVITY_ACTION)&& isBootCompleted()) {
