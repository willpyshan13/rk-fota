...
public class PackageDownloadActivity extends Activity {
	...
	void initView()
	{
		...
		mPageDownLoadView = (View)findViewById(R.id.page_downalod);
		...
		mDescriptionTV.setOnFocusChangeListener(new OnFocusChangeListener() {
			...
			public void onFocusChange(View arg0, boolean arg1) {
				...
				mDescriptionLayout.setBackgroundResource(arg1?R.drawable.upgrade_content:R.color.transparent);
		...
		//				// TODO Auto-generated method stub
		//				((VerticalViewPager)container).addView(views.get(position));
	...
	android.view.View.OnClickListener ocl = new android.view.View.OnClickListener() {
		...
		private void setCurrentPage(int page)
		{
			...
			switch (page) {
			case PAGE_DOWNLOAD:
				mPageUpgradeInfoView.setVisibility(View.GONE);
				mPageDownLoadView.setVisibility(View.VISIBLE);
				mBtnDownload.requestFocus();
				break;

			case PAGE_UPGRADE_INFO:
				mPageDownLoadView.setVisibility(View.GONE);
				mPageUpgradeInfoView.setVisibility(View.VISIBLE);
